...
function dispResolve() {
    ...
    // Table lives in the parent (main) patcher since 2026-08-23; fall back
    // to the local patcher if the subpatch is ever opened standalone.
    var pp = JSOBJ.patcher.parentpatcher || JSOBJ.patcher;
    var cells = [];
